    ...
    return (
        <React.Fragment>
            ...
            <Nav justify variant="tabs" defaultActiveKey="/home">
                ...
                <Nav.Item>
                    <Nav.Link className='text-lg add-property' eventKey="link-1" onClick={handleShowApartmentProperty}>{transactionType.toUpperCase()} YOUR COMPLEX</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                    <Nav.Link className='text-lg add-property' eventKey="link-2" onClick={handleShowComplexProperty}>{transactionType.toUpperCase()} YOUR APARTMENT</Nav.Link>
                </Nav.Item>
                <Nav.Item>
