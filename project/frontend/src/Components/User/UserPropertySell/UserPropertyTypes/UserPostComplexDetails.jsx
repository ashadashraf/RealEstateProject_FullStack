...
const UserPostComplexDetails = () => {
  ...
  const rooms = ['office', 'pantry', 'family_room', 'recreation_room', 'workshop', 'library', 'master_room'];
  ...
  const outdoorAmenities = ['balcony', 'pond', 'pool', 'porch', 'rv_parking', 'water_front', 'spa', 'sprinkler_system'];
  ...
  return (
    <Form encType='multipart/form-data' noValidate validated={validated} onSubmit={handleSubmit}>
      ...
      <Row className='mb-3 flex justify-around'>
        ...
        <Form.Group as={Col} md="4" className='pb-3' controlId="validationCustom03">
          <Form.Label>Parking sq. ft.</Form.Label>
          <Form.Control type="text" placeholder="Enter parking sqaure feet" name='garage_square_feet' value={formData.garage_square_feet} onChange={handleInputChange} />
        </Form.Group>
        <Form.Group as={Col} md="4" className='pb-3' controlId="validationCustom04">
          <Form.Label>Describe your complex</Form.Label>
      ...
      <Row className='mb-3 flex justify-around'>
        ...
        <Form.Group as={Col} md="2" lg="2" className='pb-3' controlId="validationCustom05">
          <Form.Label>What i love about this Complex</Form.Label>
...
export default UserPostComplexDetails